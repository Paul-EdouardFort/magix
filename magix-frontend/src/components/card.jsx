...
export default function Card({id=0,cost=0,hp=0,atk=0,mechanics=[],uid=0,baseHP,onClick}) {
    ...
    return <div onClick={() => onClick(uid)} className="w-[10vw] h-[25vh] bg-[url(../assets/img/Inventory_tab.png)] bg-cover bg-no-repeat text-yellow-300 flex flex-none flex-col text-center outline-offset-[-2px] p-2"  >
